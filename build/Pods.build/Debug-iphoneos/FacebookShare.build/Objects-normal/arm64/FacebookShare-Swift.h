...
/// If <code>true</code>, a sound is played when the reciever is toggled.
...
/// If <code>true</code>, a sound is played when the control is toggled.
@property (nonatomic) BOOL isSoundEnabled;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
@property (nonatomic, readonly) id _Nonnull openGraphPropertyValue;
@end
